...
export class PDFProcessorSimple {
    ...
    async splitBySize(pdf, options, originalFilename) {
        ...
        console.log(`Splitting PDF by maximum file size: ${maxSizeBytes} bytes`);
        ...
        for (let i = 0; i < totalPages; i++) {
            ...
            if (currentFileSizeEstimate > maxSizeBytes && i > currentFileStartPage) {
                ...
                console.log(`Created file for pages ${currentFileStartPage + 1}-${i}, size: ${pdfBytes.length} bytes`);
        ...
        if (currentFileStartPage < totalPages) {
            ...
            console.log(`Created final file for pages ${currentFileStartPage + 1}-${totalPages}, size: ${pdfBytes.length} bytes`);
